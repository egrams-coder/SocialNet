...
class FriendsCollectionViewController: UICollectionViewController {
    ...
    var friendCollection = [FriendsFoto(friendFoto: "1"),
                            FriendsFoto(friendFoto: "2"),
                            FriendsFoto(friendFoto: "3"),
                            FriendsFoto(friendFoto: "4"),
                            FriendsFoto(friendFoto: "5")]
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.friendAvatarImage.image = UIImage(named: friendCollection[indexPath.row].friendFoto)
